...
extension UIViewController {
    ...
    func setUpInBoxDataInDefaults() {
        ...
        let inBoxData = [
            ...
            ["recipient":"Dr. Quam","title":"Immunologist","subject":"order blood pressure plate","message":"order blood pressure plate","date":"3/1/17","time":"2:26 PM"],
            ["recipient":"John Banks","title":"Cardiologist","subject":"Dr D. Webb Telemed update","message":"Dr D. Webb Telemed update","date":"3/1/17","time":"2:55 PM"],
            ["recipient":"Tammie Summers","title":"Case Manager","subject":"Patient profile Screening update","message":"Patient profile Screening update","date":"3/1/17","time":"4:23 PM"]
        ]
