...
class InfoContainer1VC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {//move the work to a background global queue and run the work in the closure asynchronously. This lets viewDidLoad() finish earlier on the main thread and makes the loading feel more snappy.
            ...
            self.badgeLabel.attributedText = attributedString
            
            self.badgeLabel.layer.cornerRadius = 5
            self.badgeLabel.backgroundColor = UIColor.candyGreen()
            ...
            self.badgeLabel2.attributedText = attributedString2
            self.badgeLabel2.layer.cornerRadius = 5
            self.badgeLabel2.backgroundColor = UIColor.Iron()
            self.badgeLabel2.clipsToBounds = true
            //------------
            ...
            self.demographics = [["UniqueID","P000001"],
