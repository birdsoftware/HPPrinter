//
//  AlertsEventsViewController.swift
//  CarePointe
//
...
class AlertsEventsViewController: UIViewController , UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView,
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "alertsevents") as! AlertEventsTabelCell
        if(searchActive) {
