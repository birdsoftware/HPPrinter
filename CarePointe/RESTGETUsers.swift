...
//                                                                let uid = String(userID)
                                                                ...
                                                                //newUsers.append(User(id: uid, userName: userName, firstLastName: firstLastName/*firstName: firstName, lastName:lastName*/, emailID1:emailID1, roleType:roleType))
//                                                            }
...
//                                                                oldUsers.append(User(id: u, userName: uName, firstLastName: fLName/*firstName: fName, lastName:lName*/, emailID1:eID, roleType:rType))
//                                                                
//                                                            }
...
//                                                                
//                                                                users.append(["User_ID":user.id, "UserName":user.userName, "FirstLastName":user.firstLastName/*"FirstName":user.firstName, "LastName":user.lastName*/, "EmailID1":user.emailID1, "RoleType":user.roleType])
//                                                                
//                                                            }
//                                                            
//                                                            for user in newUsers {
